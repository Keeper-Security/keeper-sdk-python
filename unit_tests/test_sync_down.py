...
class VaultTestCase(unittest.TestCase):
    def test_vault_storage(self):
        ...
        sync_down.sync_down_request(auth, vs, False)
        ...
        nsds = list(vs.non_shared_data.get_all())
        self.assertTrue(len(nsds) > 0)

    @staticmethod
    def get_execute_rest(responses):   # type: (Dict) -> Callable
    ...
    def test_delete_owned_record(self):
        ...
        mock = vault.keeper_auth.execute_auth_rest    # type: MagicMock
