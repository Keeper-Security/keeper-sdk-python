...
from ..dag_types import SyncQuery, Ref, RefType, DAGData, DataPayload, EdgeType, SyncData
from ..dag_crypto import generate_random_bytes, generate_uid_str
from .... import utils
import base64
...
class DataStruct(DataStructBase):
    ...
    def data(self,
        ...
        if content is not None:
            content = utils.base64_url_encode(content)
