...
class PAMOnlineController(_message.Message):
    __slots__ = ["controllerUid", "connectedOn", "ipAddress", "version"]
    CONTROLLERUID_FIELD_NUMBER: _ClassVar[int]
    ...
    ipAddress: str
    version: str
    def __init__(self, controllerUid: _Optional[bytes] = ..., connectedOn: _Optional[int] = ..., ipAddress: _Optional[str] = ..., version: _Optional[str] = ...) -> None: ...
...
class ConfigurationAddRequest(_message.Message):
    __slots__ = ["configurationUid", "recordKey", "data", "recordLinks"]
    CONFIGURATIONUID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, configurationUid: _Optional[bytes] = ..., recordKey: _Optional[bytes] = ..., data: _Optional[bytes] = ..., recordLinks: _Optional[_Iterable[_Union[_record_pb2.RecordLink, _Mapping]]] = ...) -> None: ...
