...
class BreachWatch:
    def __init__(self, auth: keeper_auth.KeeperAuth) -> None:
        ...
        self.endpoint.proxies = keeper_endpoint.proxies
        self.endpoint.certificate_check = keeper_endpoint.certificate_check
    ...
    def scan_passwords(self, passwords: Iterable[Union[str, Tuple[str, Optional[bytes]]]]) -> Iterator[Tuple[str, Optional[breachwatch_pb2.HashStatus]]]:
