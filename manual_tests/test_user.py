...
class MyTestCase(unittest.TestCase):
    ...
    def test_record_update(self):
        ...
        typed_record_uid = next((x.record_uid for x in vault.records() if x.version == 3 and x.record_type == 'login'), None)
    ...
    @staticmethod
    def wipe_vault(vault):  # type: (vault_online.VaultOnline) -> None
