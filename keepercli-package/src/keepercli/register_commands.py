...
def register_commands(commands: base.CliCommands, scopes: Optional[base.CommandScope] = None):
    ...
    if not scopes or bool(scopes & base.CommandScope.Vault):
        ...
        commands.register_command('record-history', record_edit.RecordHistoryCommand(), base.CommandScope.Vault, 'rh')
        commands.register_command('clipboard-copy', record_edit.ClipboardCommand(), base.CommandScope.Vault, 'cc')
        commands.register_command('find-password', record_edit.ClipboardCommand(), base.CommandScope.Vault)
