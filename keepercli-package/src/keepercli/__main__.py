...
def get_params_from_config(config_filename: Optional[str]) -> params.KeeperParams:
...
def main():
    ...
    if opts.fail_on_throttle:
        params.fail_on_throttle = opts.fail_on_throttle
    ...
    sys.exit(cli.loop(params, commands))
