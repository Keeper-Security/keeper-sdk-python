...
import keepersdk
from keepersdk.vault import vault_online, vault_record, vault_extensions, record_management
...
def find_email_config_record(vault: vault_online.VaultOnline, name: str) -> Optional[str]:
    """
    Find email config record by name.

    Args:
        vault: VaultOnline session
...
def load_email_config_from_record(vault: vault_online.VaultOnline, record_uid: str) -> EmailConfig:
    """
...
def update_oauth_tokens_in_record(vault: vault_online.VaultOnline, record_uid: str,
