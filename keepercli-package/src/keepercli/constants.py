...
_ENFORCEMENTS: List[Tuple[str, int, str, str]] = [
    ...
    ("TWO_FACTOR_BY_IP", 87, "JSONARRAY", "TWO_FACTOR_AUTHENTICATION"),
    ...
    ("MASTER_PASSWORD_REENTRY", 203, "JSON", "KEEPER_FILL"),
