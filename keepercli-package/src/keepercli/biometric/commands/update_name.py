...
class BiometricUpdateNameCommand(BiometricArgparseCommand):
    ...
    def execute(self, context: KeeperParams, **kwargs):
        ...
        def _update_name():
            vault = context.vault
            all_credentials = self._get_available_credentials_or_error(vault)
            ...
            result = self.client.update_passkey_name(vault, target_credential['id'], target_credential['credential_id'], friendly_name)
