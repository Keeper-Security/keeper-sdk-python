...
class BiometricVerifyCommand(BiometricArgparseCommand):
    ...
    def _verify_authentication_response(self, vault: vault_online.VaultOnline, auth_options, assertion_response, purpose):
        ...
        try:
            ...
            return self._send_verification_request(vault, auth_options, assertion_object, purpose)
