...
class RecordEditMixin(typed_field_utils.TypedFieldMixin):
    def __init__(self) -> None:
        ...
        self.logger: Optional[logging.Logger] = api.get_logger()
...
class RecordDeleteAttachmentCommand(base.ArgparseCommand):
    ...
    def execute(self, context, **kwargs):
        ...
        if len(deleted_files) == 0:
            logging.info('Attachment(s) not found')
            return
    ...
    def execute(self, context, **kwargs):
        ...
        for record_uid in record_uids:
            ...
            if preserve_dir:
                ...
                if folder:
                    subfolder_path = folder_utils.get_folder_path(context.vault.vault_data, folder.folder_uid, os.sep)
