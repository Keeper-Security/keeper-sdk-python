...
from keepersdk.vault import vault_types, vault_record, folder_management, record_management
from . import base
            ...
            if show_detail:
                ...
                if len(records) > 0:
                    ...
                    for record in records:
                        flag = 'r-'
                        flag += 'A' if record.has_attachments else '-'
                        flag += 'S' if record.shared else '-'
