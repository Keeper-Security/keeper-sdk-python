...
from cryptography.hazmat.primitives.asymmetric.rsa import RSAPublicKey as PublicKey, RSAPrivateKey as PrivateKey

def get_random_bytes(length: int) -> bytes: ...

def load_private_key(der_private_key: bytes, password: Optional[str] = ...) -> PrivateKey: ...
def load_public_key(der_public_key: bytes) -> PublicKey: ...
...
def encrypt_rsa(data: bytes, rsa_key: PublicKey) -> bytes: ...
def decrypt_rsa(data: bytes, rsa_key: PrivateKey) -> bytes: ...
