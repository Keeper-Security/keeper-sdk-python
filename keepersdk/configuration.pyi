...
class IConfiguration(Protocol):
    ...
    def get_user_configuration(self, username: str) -> Optional[IUserConfiguration]: ...
    def get_server_configuration(self, server: str) -> Optional[IServerConfiguration]: ...

class IConfigurationStorage(Protocol):
    def get_configuration(self) -> IConfiguration:  ...
    def put_configuration(self, configuration: IConfiguration) -> None: ...
