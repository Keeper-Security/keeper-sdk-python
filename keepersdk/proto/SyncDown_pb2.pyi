...
class Team(_message.Message):
    __slots__ = ["teamUid", "name", "teamKey", "teamKeyType", "teamPrivateKey", "restrictEdit", "restrictShare", "restrictView", "removedSharedFolders", "sharedFolderKeys"]
    ...
    def __init__(self, teamUid: _Optional[bytes] = ..., name: _Optional[str] = ..., teamKey: _Optional[bytes] = ..., teamKeyType: _Optional[_Union[_record_pb2.RecordKeyType, str]] = ..., teamPrivateKey: _Optional[bytes] = ..., restrictEdit: bool = ..., restrictShare: bool = ..., restrictView: bool = ..., removedSharedFolders: _Optional[_Iterable[bytes]] = ..., sharedFolderKeys: _Optional[_Iterable[_Union[SharedFolderKey, _Mapping]]] = ...) -> None: ...
...
class SharedFolderFolderRecord(_message.Message):
    __slots__ = ["sharedFolderUid", "folderUid", "recordUid"]
    SHAREDFOLDERUID_FIELD_NUMBER: _ClassVar[int]
    FOLDERUID_FIELD_NUMBER: _ClassVar[int]
    RECORDUID_FIELD_NUMBER: _ClassVar[int]
    sharedFolderUid: bytes
    folderUid: bytes
    recordUid: bytes
    def __init__(self, sharedFolderUid: _Optional[bytes] = ..., folderUid: _Optional[bytes] = ..., recordUid: _Optional[bytes] = ...) -> None: ...
...
class RecordMetaData(_message.Message):
    __slots__ = ["recordUid", "owner", "recordKey", "recordKeyType", "canShare", "canEdit", "ownerAccountUid", "expiration"]
    RECORDUID_FIELD_NUMBER: _ClassVar[int]
    OWNER_FIELD_NUMBER: _ClassVar[int]
    RECORDKEY_FIELD_NUMBER: _ClassVar[int]
    ...
    ownerAccountUid: bytes
    expiration: int
    def __init__(self, recordUid: _Optional[bytes] = ..., owner: bool = ..., recordKey: _Optional[bytes] = ..., recordKeyType: _Optional[_Union[_record_pb2.RecordKeyType, str]] = ..., canShare: bool = ..., canEdit: bool = ..., ownerAccountUid: _Optional[bytes] = ..., expiration: _Optional[int] = ...) -> None: ...
...
class PendingTeamMember(_message.Message):
    __slots__ = ["enterpriseUserId", "userPublicKey", "teamUids"]
    ...
    def __init__(self, enterpriseUserId: _Optional[int] = ..., userPublicKey: _Optional[bytes] = ..., teamUids: _Optional[_Iterable[bytes]] = ...) -> None: ...
...
class SharedFolderRecord(_message.Message):
    __slots__ = ["sharedFolderUid", "recordUid", "recordKey", "canShare", "canEdit", "ownerAccountUid", "expiration", "owner"]
    SHAREDFOLDERUID_FIELD_NUMBER: _ClassVar[int]
    RECORDUID_FIELD_NUMBER: _ClassVar[int]
    RECORDKEY_FIELD_NUMBER: _ClassVar[int]
    CANSHARE_FIELD_NUMBER: _ClassVar[int]
    ...
    expiration: int
    owner: bool
    def __init__(self, sharedFolderUid: _Optional[bytes] = ..., recordUid: _Optional[bytes] = ..., recordKey: _Optional[bytes] = ..., canShare: bool = ..., canEdit: bool = ..., ownerAccountUid: _Optional[bytes] = ..., expiration: _Optional[int] = ..., owner: bool = ...) -> None: ...

class SharedFolderUser(_message.Message):
    __slots__ = ["sharedFolderUid", "username", "manageRecords", "manageUsers", "accountUid", "expiration"]
    SHAREDFOLDERUID_FIELD_NUMBER: _ClassVar[int]
    ...
    accountUid: bytes
    expiration: int
    def __init__(self, sharedFolderUid: _Optional[bytes] = ..., username: _Optional[str] = ..., manageRecords: bool = ..., manageUsers: bool = ..., accountUid: _Optional[bytes] = ..., expiration: _Optional[int] = ...) -> None: ...

class SharedFolderTeam(_message.Message):
    __slots__ = ["sharedFolderUid", "teamUid", "name", "manageRecords", "manageUsers", "expiration"]
    SHAREDFOLDERUID_FIELD_NUMBER: _ClassVar[int]
    TEAMUID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    MANAGERECORDS_FIELD_NUMBER: _ClassVar[int]
    ...
    manageUsers: bool
    expiration: int
    def __init__(self, sharedFolderUid: _Optional[bytes] = ..., teamUid: _Optional[bytes] = ..., name: _Optional[str] = ..., manageRecords: bool = ..., manageUsers: bool = ..., expiration: _Optional[int] = ...) -> None: ...

class KsmChange(_message.Message):
    __slots__ = ["appRecordUid", "detailId", "removed"]
    ...
    detailId: bytes
    removed: bool
    def __init__(self, appRecordUid: _Optional[bytes] = ..., detailId: _Optional[bytes] = ..., removed: bool = ...) -> None: ...
...
class RecordRotation(_message.Message):
    __slots__ = ["recordUid", "revision", "configurationUid", "schedule", "pwdComplexity", "disabled", "resourceUid"]
    RECORDUID_FIELD_NUMBER: _ClassVar[int]
    REVISION_FIELD_NUMBER: _ClassVar[int]
    ...
    disabled: bool
    resourceUid: bytes
    def __init__(self, recordUid: _Optional[bytes] = ..., revision: _Optional[int] = ..., configurationUid: _Optional[bytes] = ..., schedule: _Optional[str] = ..., pwdComplexity: _Optional[bytes] = ..., disabled: bool = ..., resourceUid: _Optional[bytes] = ...) -> None: ...
