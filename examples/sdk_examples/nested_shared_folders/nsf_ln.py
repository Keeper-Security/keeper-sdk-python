...
def nsf_ln(vault: vault_online.VaultOnline) -> None:
    """Link an NSF record into a folder (nsf-ln)."""
...
def nsf_ln_run(keeper_auth_context: keeper_auth.KeeperAuth) -> None:
...
def main() -> None:
    ...
    if keeper_auth_context:
        nsf_ln_run(keeper_auth_context)
    else:
        print("Login failed.")
