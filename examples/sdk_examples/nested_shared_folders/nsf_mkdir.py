...
def nsf_mkdir(vault: vault_online.VaultOnline) -> None:
    """Create an NSF folder (nsf-mkdir)."""
    ...
    if created_uid:
        print(f"NSF folder created: {created_uid}")


def nsf_mkdir_run(keeper_auth_context: keeper_auth.KeeperAuth) -> None:
...
def main() -> None:
    ...
    if keeper_auth_context:
        nsf_mkdir_run(keeper_auth_context)
    else:
        print("Login failed.")
