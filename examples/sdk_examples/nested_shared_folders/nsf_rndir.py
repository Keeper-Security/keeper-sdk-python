...
def nsf_rndir(vault: vault_online.VaultOnline) -> None:
    """Rename or recolor an NSF folder (nsf-rndir)."""
    ...
    print(f"Folder updated: {result.folder_uid}")


def nsf_rndir_run(keeper_auth_context: keeper_auth.KeeperAuth) -> None:
...
def main() -> None:
    ...
    if keeper_auth_context:
        nsf_rndir_run(keeper_auth_context)
    else:
        print("Login failed.")
