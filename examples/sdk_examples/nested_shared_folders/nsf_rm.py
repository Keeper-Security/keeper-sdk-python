...
def nsf_rm(vault: vault_online.VaultOnline) -> None:
    """Remove NSF record(s) (nsf-rm)."""
...
def nsf_rm_run(keeper_auth_context: keeper_auth.KeeperAuth) -> None:
...
def main() -> None:
    ...
    if keeper_auth_context:
        nsf_rm_run(keeper_auth_context)
    else:
        print("Login failed.")
