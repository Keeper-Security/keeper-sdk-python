...
def nsf_rmdir(vault: vault_online.VaultOnline) -> None:
    """Remove NSF folder(s) (nsf-rmdir)."""
    ...
    if result.confirmed:
        ...
        print("Folder removal was not confirmed by the server.")


def nsf_rmdir_run(keeper_auth_context: keeper_auth.KeeperAuth) -> None:
...
def main() -> None:
    ...
    if keeper_auth_context:
        nsf_rmdir_run(keeper_auth_context)
    else:
        print("Login failed.")
