...
def main():
    ...
    enterprise_user_ids = [0]

    try:
        devices = device_management.list_admin_devices(
            keeper_auth_context, enterprise_user_ids
        )
        print_admin_devices_table(devices)
    except Exception as e:
        print(f'Error listing admin devices: {e}')
    finally:
